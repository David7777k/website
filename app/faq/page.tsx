...
export default async function FAQPage() {
  ...
  const defaultFAQs = [
    ...
    },
    {
      ...
      answer: "Так, у нас є функція чайових. Натисніть на плаваючу кнопку 'Чайові майстру', оберіть працівника та суму. Вам буде показано номер картки майстра для переказу."
    },
    {
