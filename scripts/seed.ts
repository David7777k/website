  ...
  try {
    ...
    if (prizeCount === 0) {
      await prisma.wheelPrize.createMany({
        data: [
          {
            name: 'Знижка 10% на кальян',
            description: 'Отримайте знижку 10% на будь-який кальян',
            type: 'discount',
            value: 10,
            probability: 25,
            color: '#10B981',
          ...
          {
            name: 'Знижка 15% на кухню',
            description: 'Знижка 15% на всі страви',
            type: 'discount',
            value: 15,
            probability: 20,
            color: '#3B82F6',
          ...
          {
            name: 'Безкоштовний чай',
            description: 'Чай в подарунок',
            type: 'free_item',
            probability: 20,
            color: '#8B5CF6',
            icon: '🍵',
          ...
          {
            name: 'Трек безкоштовно',
            description: 'Обирай свій трек безкоштовно',
            type: 'free_item',
            probability: 15,
            color: '#EC4899',
            icon: '🎵',
          ...
          {
            name: 'Коктейль -20%',
            description: 'Знижка 20% на будь-який коктейль',
            type: 'discount',
            value: 20,
            probability: 10,
            color: '#F59E0B',
          ...
          {
            name: 'Комбо -25%',
            description: 'Знижка 25% на комбо-набір',
            type: 'discount',
            value: 25,
            probability: 8,
            color: '#EF4444',
          ...
          {
            name: 'VIP стіл на годину',
            description: 'Безкоштовна година в VIP-зоні',
            type: 'special',
            probability: 2,
            color: '#9333EA',
            icon: '👑',
